...
{
	NIM_SDK_Get_Function(nim_vchat_add_device_status_cb)(type, cb, nullptr);
}
//移除设备监听（摄像头和麦克风）
...
{
	NIM_SDK_Get_Function(nim_vchat_set_audio_data_cb)(capture, cb, nullptr);
}
...
{
	NIM_SDK_Get_Function(nim_vchat_set_video_data_cb)(capture, cb, nullptr);
}
...
{
	NIM_SDK_Get_Function(nim_vchat_set_cb_func)(cb, nullptr);
}
//启动通话
//json_info 见nim_vchat_def.h
