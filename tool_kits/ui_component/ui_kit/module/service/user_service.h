...
typedef std::function<void(UserChangeType change_type, const nim::UserNameCard&)> OnFriendListChangeCallback;
...
private:
	...
	void InvokeFriendListChangeCallback(UserChangeType change_type, const nim::UserNameCard& uinfo);
	void UIFriendListChangeCallback(UserChangeType change_type, const nim::UserNameCard& uinfo);
